...
p + theme_linedraw()+ #draws in the lines 
  theme(axis.text.x = element_text(angle = 60, hjust=1)) #need to retell this one 
```
...
q + 
  theme_classic() + 
  scale_fill_manual(values= paletteer_d("ggprism::plasma"))#fix 
...
homerange %>% 
  ...
  theme(axis.text.x = element_text(angle = 60, hjust = 1),
        legend.position = "none",
        strip.text = element_text(size = 8, face ="bold")) #adjust titles 
```
