...
## MIDTERM 2 NOTES
```{r}
study = fasting beahvior of polar bears in SB and CS. 
1983 to 2017
BUN is blood urea nitrogen
cretinine 
... use to calculate ratio that indicates whether bear = fasting 
#abstract.... 
more than 7 days... 1448 samples from 1177 adults and subadult bears... should check result to paper later (highlighted) 

popn --> population which ber belongs
lat and long for ltitude and longitude

#NA...
bear id shouldn't have any 
date is date
...
cused on the fasting behavior of polar bears in the Southern Beaufort (SB) and Chukchi seas (CS). 
