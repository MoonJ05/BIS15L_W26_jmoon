...
```{r}
life_history %>% 
  summarize(across(everything(), ~sum(.==-999.00)))
```
...
#NA is probaly being represented as 0... 
```
...
```{r message=FALSE, warning=FALSE}
cites <- read_csv("/Users/jm123/Documents/GitHub/BIS15L_W26_jmoon/lab13/data/cites.csv") %>% 
  clean_names() #important!
```
