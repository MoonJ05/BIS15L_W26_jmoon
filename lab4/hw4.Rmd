...
Comparing the median, the insectivore vore type seems like they sleep the most. 
...
Looking at relationship between rem sleep and sleep total 
```{r}
#scatter plot 
ggplot(data=msleep, mapping=aes(x=sleep_total, y=sleep_rem))+
  geom_point(mapping=aes(color=vore, shape=vore))+ #added vore types for more insights
  geom_smooth(method=lm, se=T)+ #added line of best fit, with standard error
  labs(title="Sleep Total (hrs) vs. Rem Sleep (hrs)", x="Sleep Total (hrs)", y="Rem Sleep (hrs)")
```
