...
```{bash} 
#empty or bash 
mv UKWF6UD7016-Alignment-Descriptions.csv genome01_blastn.csv
ls BIS15L_W26_jmoon/lab16/data/blast_results/
```
...
#for fasta use biostrings library. Can't just do read_csv 
```
