...
In 2023 specifically, the Russian Federatio had the highest catch of the Alaska pollock. 
...
fisheries_clean %>% 
  ...
  geom_point (na.rm = T, mapping = aes (color = period, shape=period)) + #TAKE OUT aes if not needed
